...
function setOfCachedUrls(e) {
...
}var precacheConfig = [["/bdt-poc/index.html", "062482c1b53f033ef9358d78513ac5d6"], ["/bdt-poc/static/css/main.21505739.css", "7ebd29d5ccfc37e71ae12fdd9d160080"], ["/bdt-poc/static/js/main.5f914ac7.js", "bf06bf67fe6036edf3a86510fd8f7c8e"]],
  ...
  if ("GET" === e.request.method) {
    var t,
        n = stripIgnoredUrlParameters(e.request.url, ignoreUrlParametersMatching);(t = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, "index.html"), t = urlsToCacheKeys.has(n));!t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/bdt-poc/index.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function (e) {
